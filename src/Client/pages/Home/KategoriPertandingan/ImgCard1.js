    ...
    <Card className={classes.root}>
      ...
      <CardContent>
        <Typography variant="body2" color="textSecondary" component="p">
          Kategori Open Perorangan: Pra Usia Dini – Usia Dini – Pra Pemula – Pemula – Kadet – Junior
        </Typography>
      </CardContent>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography paragraph>
            Klasifikasi Usia:
            <ol>
              <li>Pra Usia Dini (6 s.d. 7 Tahun)</li>
              <ul>
                <li>Tahun Kelahiran 2013 s.d. 2014</li>
                <li>Babak Penyisihan: Kata 1 dan 2</li>
                <li>Babak Final: Kata 3</li>
              </ul>
              <li>Usia Dini (8 s.d. 9 Tahun)</li>
              <ul>
                <li>Tahun Kelahiran 2011 s.d. 2012</li>
                <li>Babak Penyisihan: Kata 1 s.d. 5</li>
                <li>Babak Final: Kata WKF</li>
              </ul>
              <li>Pra Pemula (10 s.d. 11 Tahun)</li>
              <ul>
                <li>Tahun Kelahiran 2009 s.d. 2010</li>
                <li>Babak Penyisihan: Kata 1 s.d. 5</li>
                <li>Babak Final: Kata WKF</li>
              </ul>
              <li>Pemula (12 s.d. 13 Tahun)</li>
              <ul>
                <li>Tahun Kelahiran 2007 s.d. 2008</li>
                <li>Babak Penyisihan: Kata WKF</li>
                <li>Babak Final: Kata WKF</li>
              </ul>
              <li>Kadet (14 s.d. 15 Tahun)</li>
              <ul>
                <li>Tahun Kelahiran 2005 s.d. 2006</li>
                <li>Babak Penyisihan: Kata WKF</li>
                <li>Babak Final: Kata WKF</li>
              </ul>
              <li>Junior (16 s.d. 17 Tahun)</li>
              <ul>
                <li>Tahun Kelahiran 2003 s.d. 2004</li>
                <li>Babak Penyisihan: Kata WKF</li>
                <li>Babak Final: Kata WKF</li>
              </ul>
            </ol>
